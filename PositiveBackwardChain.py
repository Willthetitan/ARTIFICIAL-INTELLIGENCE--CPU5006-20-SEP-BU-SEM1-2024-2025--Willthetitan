...
def rule_based_prediction(row):
        ...
        if row['chest_pain_type'] == 'Typical angina' and row['vessels_colored_by_flourosopy'] == 'Two' or row['vessels_colored_by_flourosopy'] == 'Three' and row['oldpeak'] >= 2 and row['slope'] == 'Downsloping':
             return 1
